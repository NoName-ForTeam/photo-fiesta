...
export const ru: LocaleType = {
  ...
  devices: {
    ...
    noLoggedDevices: 'Вы еще не входили в систему с других устройств',
  ...
  posts: {
    ...
    closePost: 'Удалить пост',
    closePostText:
      'Вы действительно хотите закрыть редактирование публикации? Если закроете, то изменения не сохранятся.',
    copyLink: 'Копировать ссылку',
    delete: 'Удалить пост',
    deletePost: 'Удаление поста',
    deletePostText: 'Вы действительно хотите удалить пост?',
    edit: 'Редактировать пост',
    noImage: 'Нет выбранных изображений',
